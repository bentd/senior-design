...
HD_PWD='C:/Users/bentd/Documents/EEL4920/AES_128_Overlay/AES_128_Overlay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log aes_128_overlay_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source aes_128_overlay_wrapper.tcl -notrace
