...
ISEStep( "vivado",
         "-log aes_128_encryption_overlay_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source aes_128_encryption_overlay_wrapper.tcl -notrace" );
