...
HD_PWD='D:/Senior Design/Technical Work/Vivado/AES_128_Encryption_Overlay/AES_128_Encryption_Overlay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log aes_128_encryption_overlay_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source aes_128_encryption_overlay_wrapper.tcl -notrace
