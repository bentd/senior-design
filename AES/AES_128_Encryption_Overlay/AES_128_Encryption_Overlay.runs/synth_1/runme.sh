...
HD_PWD='D:/Senior Design/Technical Work/Vivado/AES_128_Encryption_Overlay/AES_128_Encryption_Overlay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aes_128_encryption_overlay_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aes_128_encryption_overlay_wrapper.tcl
